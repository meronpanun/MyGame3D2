...
SceneResult::SceneResult()
    : m_bgmHandle(-1), m_gameClearImageHandle(-1), m_isBGMStarted(false),
      m_backgroundHandle(-1), m_scrollX(0.0f), m_scrollY(0.0f),
      m_japaneseFontHandle(-1), m_arialBlackFontHandle(-1),
      m_arialBlackLargeFontHandle(-1), m_japaneseLargeFontHandle(-1),
