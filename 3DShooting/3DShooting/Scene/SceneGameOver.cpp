...
void SceneGameOver::Draw()
{
    ...
    for (int y = -1; y < 2; y++)
    {
        for (int x = -1; x < 2; x++)
        {
            ...
            DrawExtendGraph(drawX, drawY, drawX + kBgImageSize,
                            drawY + kBgImageSize, m_backgroundHandle, true);
        }
    }
    ...
    DrawFormatStringToHandle(m_layout.textValueX, textY, 0xffffff, m_japaneseLargeFontHandle, "%d", ScoreManager::Instance().GetDisplayScore());
    ...
    DrawBox(m_layout.titleBtnX1, m_layout.titleBtnY1, m_layout.titleBtnX2, m_layout.titleBtnY2, 0xffffff, false); // 枠線
    ...
    DrawFormatStringToHandle(
        m_layout.titleBtnX1 + (m_layout.btnW - titleTextWidth) / 2,
    ...
    DrawBox(m_layout.retryBtnX1, m_layout.retryBtnY1, m_layout.retryBtnX2, m_layout.retryBtnY2, 0xffffff, false); // 枠線
    ...
    DrawFormatStringToHandle(
        m_layout.retryBtnX1 + (m_layout.btnW - retryTextWidth) / 2,
