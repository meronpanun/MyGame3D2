#include "AcidZombie.h"
#include "Player.h"
#include "DxLib.h"

AcidZombie::AcidZombie() {
...
void AcidZombie::Draw() {
    if (!IsDead()) {
        MV1DrawModel(m_modelHandle);
    }
}

void AcidZombie::UpdateState() {
...
void AcidZombie::UpdateMovement() {
