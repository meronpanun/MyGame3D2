...
void RunnerZombie::Draw() {
    if (!IsDead()) {
        MV1DrawModel(m_modelHandle);
    }
}

void RunnerZombie::UpdateState() {
...
void RunnerZombie::UpdateMovement() {
...
void RunnerZombie::UpdateAttack() {
